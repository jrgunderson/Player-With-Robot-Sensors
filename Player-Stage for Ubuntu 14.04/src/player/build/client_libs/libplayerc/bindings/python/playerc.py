...
class player_gps_data_t(_object):
    ...
    if _newclass:speed = _swig_property(_playerc.player_gps_data_t_speed_get, _playerc.player_gps_data_t_speed_set)
    ...
    if _newclass:course = _swig_property(_playerc.player_gps_data_t_course_get, _playerc.player_gps_data_t_course_set)
...
class player_camera_source_t(_object):
    ...
    if _newclass:norm_count = _swig_property(_playerc.player_camera_source_t_norm_count_get, _playerc.player_camera_source_t_norm_count_set)
    ...
    if _newclass:norm = _swig_property(_playerc.player_camera_source_t_norm_get, _playerc.player_camera_source_t_norm_set)
    ...
    if _newclass:source = _swig_property(_playerc.player_camera_source_t_source_get, _playerc.player_camera_source_t_source_set)
    def __init__(self): 
...
class player_map_data_t(_object):
    ...
    if _newclass:data_range = _swig_property(_playerc.player_map_data_t_data_range_get, _playerc.player_map_data_t_data_range_set)
...
class player_planner_waypoints_req_t(_object):
    ...
    if _newclass:waypoints_distance = _swig_property(_playerc.player_planner_waypoints_req_t_waypoints_distance_get, _playerc.player_planner_waypoints_req_t_waypoints_distance_set)
...
class player_graphics2d_cmd_multiline_t(_object):
    ...
    if _newclass:points_count = _swig_property(_playerc.player_graphics2d_cmd_multiline_t_points_count_get, _playerc.player_graphics2d_cmd_multiline_t_points_count_set)
    ...
    if _newclass:points = _swig_property(_playerc.player_graphics2d_cmd_multiline_t_points_get, _playerc.player_graphics2d_cmd_multiline_t_points_set)
    ...
    if _newclass:color = _swig_property(_playerc.player_graphics2d_cmd_multiline_t_color_get, _playerc.player_graphics2d_cmd_multiline_t_color_set)
    def __init__(self): 
...
class player_imu_reset_euler_config_t(_object):
    ...
    if _newclass:orientation = _swig_property(_playerc.player_imu_reset_euler_config_t_orientation_get, _playerc.player_imu_reset_euler_config_t_orientation_set)
    def __init__(self): 
...
class player_coopobject_header_t(_object):
    ...
    if _newclass:origin = _swig_property(_playerc.player_coopobject_header_t_origin_get, _playerc.player_coopobject_header_t_origin_set)
    ...
    if _newclass:id = _swig_property(_playerc.player_coopobject_header_t_id_get, _playerc.player_coopobject_header_t_id_set)
    ...
    if _newclass:parent_id = _swig_property(_playerc.player_coopobject_header_t_parent_id_get, _playerc.player_coopobject_header_t_parent_id_set)
    def __init__(self): 
...
class player_coopobject_rssi_t(_object):
    ...
    if _newclass:header = _swig_property(_playerc.player_coopobject_rssi_t_header_get, _playerc.player_coopobject_rssi_t_header_set)
    ...
    if _newclass:sender_id = _swig_property(_playerc.player_coopobject_rssi_t_sender_id_get, _playerc.player_coopobject_rssi_t_sender_id_set)
    ...
    if _newclass:rssi = _swig_property(_playerc.player_coopobject_rssi_t_rssi_get, _playerc.player_coopobject_rssi_t_rssi_set)
    ...
    if _newclass:stamp = _swig_property(_playerc.player_coopobject_rssi_t_stamp_get, _playerc.player_coopobject_rssi_t_stamp_set)
    ...
    if _newclass:nodeTimeHigh = _swig_property(_playerc.player_coopobject_rssi_t_nodeTimeHigh_get, _playerc.player_coopobject_rssi_t_nodeTimeHigh_set)
    ...
    if _newclass:nodeTimeLow = _swig_property(_playerc.player_coopobject_rssi_t_nodeTimeLow_get, _playerc.player_coopobject_rssi_t_nodeTimeLow_set)
    ...
    if _newclass:x = _swig_property(_playerc.player_coopobject_rssi_t_x_get, _playerc.player_coopobject_rssi_t_x_set)
    ...
    if _newclass:y = _swig_property(_playerc.player_coopobject_rssi_t_y_get, _playerc.player_coopobject_rssi_t_y_set)
    ...
    if _newclass:z = _swig_property(_playerc.player_coopobject_rssi_t_z_get, _playerc.player_coopobject_rssi_t_z_set)
    def __init__(self): 
...
class player_coopobject_position_t(_object):
    ...
    if _newclass:header = _swig_property(_playerc.player_coopobject_position_t_header_get, _playerc.player_coopobject_position_t_header_set)
    ...
    if _newclass:x = _swig_property(_playerc.player_coopobject_position_t_x_get, _playerc.player_coopobject_position_t_x_set)
    ...
    if _newclass:y = _swig_property(_playerc.player_coopobject_position_t_y_get, _playerc.player_coopobject_position_t_y_set)
    ...
    if _newclass:z = _swig_property(_playerc.player_coopobject_position_t_z_get, _playerc.player_coopobject_position_t_z_set)
    ...
    if _newclass:status = _swig_property(_playerc.player_coopobject_position_t_status_get, _playerc.player_coopobject_position_t_status_set)
    def __init__(self): 
...
class player_coopobject_sensor_t(_object):
    ...
    if _newclass:type = _swig_property(_playerc.player_coopobject_sensor_t_type_get, _playerc.player_coopobject_sensor_t_type_set)
    ...
    if _newclass:value = _swig_property(_playerc.player_coopobject_sensor_t_value_get, _playerc.player_coopobject_sensor_t_value_set)
    def __init__(self): 
...
class player_coopobject_data_sensor_t(_object):
    ...
    if _newclass:header = _swig_property(_playerc.player_coopobject_data_sensor_t_header_get, _playerc.player_coopobject_data_sensor_t_header_set)
    ...
    if _newclass:data_count = _swig_property(_playerc.player_coopobject_data_sensor_t_data_count_get, _playerc.player_coopobject_data_sensor_t_data_count_set)
    ...
    if _newclass:data = _swig_property(_playerc.player_coopobject_data_sensor_t_data_get, _playerc.player_coopobject_data_sensor_t_data_set)
    def __init__(self): 
...
class player_coopobject_data_userdefined_t(_object):
    ...
    if _newclass:header = _swig_property(_playerc.player_coopobject_data_userdefined_t_header_get, _playerc.player_coopobject_data_userdefined_t_header_set)
    ...
    if _newclass:type = _swig_property(_playerc.player_coopobject_data_userdefined_t_type_get, _playerc.player_coopobject_data_userdefined_t_type_set)
    ...
    if _newclass:data_count = _swig_property(_playerc.player_coopobject_data_userdefined_t_data_count_get, _playerc.player_coopobject_data_userdefined_t_data_count_set)
    ...
    if _newclass:data = _swig_property(_playerc.player_coopobject_data_userdefined_t_data_get, _playerc.player_coopobject_data_userdefined_t_data_set)
    def __init__(self): 
...
class player_coopobject_req_t(_object):
    ...
    if _newclass:header = _swig_property(_playerc.player_coopobject_req_t_header_get, _playerc.player_coopobject_req_t_header_set)
    ...
    if _newclass:request = _swig_property(_playerc.player_coopobject_req_t_request_get, _playerc.player_coopobject_req_t_request_set)
    ...
    if _newclass:parameters_count = _swig_property(_playerc.player_coopobject_req_t_parameters_count_get, _playerc.player_coopobject_req_t_parameters_count_set)
    ...
    if _newclass:parameters = _swig_property(_playerc.player_coopobject_req_t_parameters_get, _playerc.player_coopobject_req_t_parameters_set)
    def __init__(self): 
...
class player_coopobject_cmd_t(_object):
    ...
    if _newclass:header = _swig_property(_playerc.player_coopobject_cmd_t_header_get, _playerc.player_coopobject_cmd_t_header_set)
    ...
    if _newclass:command = _swig_property(_playerc.player_coopobject_cmd_t_command_get, _playerc.player_coopobject_cmd_t_command_set)
    ...
    if _newclass:parameters_count = _swig_property(_playerc.player_coopobject_cmd_t_parameters_count_get, _playerc.player_coopobject_cmd_t_parameters_count_set)
    ...
    if _newclass:parameters = _swig_property(_playerc.player_coopobject_cmd_t_parameters_get, _playerc.player_coopobject_cmd_t_parameters_set)
    def __init__(self): 
...
class uint8_tArray(_object):
    ...
    if _newclass:actual = _swig_property(_playerc.uint8_tArray_actual_get, _playerc.uint8_tArray_actual_set)
    def __getitem__(self, *args): return _playerc.uint8_tArray___getitem__(self, *args)
    def __setitem__(self, *args): return _playerc.uint8_tArray___setitem__(self, *args)
    def __init__(self): 
...
class playerc_camera(_object):
    ...
    if _newclass:norm = _swig_property(_playerc.playerc_camera_norm_get, _playerc.playerc_camera_norm_set)
    ...
    if _newclass:source = _swig_property(_playerc.playerc_camera_source_get, _playerc.playerc_camera_source_set)
    def __init__(self, *args): 
    ...
    def set_source(self, *args): return _playerc.playerc_camera_set_source(self, *args)
    def get_source(self): return _playerc.playerc_camera_get_source(self)
    def get_image(self): return _playerc.playerc_camera_get_image(self)
    def copy_image(self, *args): return _playerc.playerc_camera_copy_image(self, *args)
    def get_pixel_component(self, *args): return _playerc.playerc_camera_get_pixel_component(self, *args)
...
class playerc_coopobject(_object):
    ...
    if _newclass:info = _swig_property(_playerc.playerc_coopobject_info_get, _playerc.playerc_coopobject_info_set)
    ...
    if _newclass:messageType = _swig_property(_playerc.playerc_coopobject_messageType_get, _playerc.playerc_coopobject_messageType_set)
    ...
    if _newclass:origin = _swig_property(_playerc.playerc_coopobject_origin_get, _playerc.playerc_coopobject_origin_set)
    __swig_setmethods__["id"] = _playerc.playerc_coopobject_id_set
    __swig_getmethods__["id"] = _playerc.playerc_coopobject_id_get
    if _newclass:id = _swig_property(_playerc.playerc_coopobject_id_get, _playerc.playerc_coopobject_id_set)
    ...
    if _newclass:parent_id = _swig_property(_playerc.playerc_coopobject_parent_id_get, _playerc.playerc_coopobject_parent_id_set)
    ...
    if _newclass:RSSIsender = _swig_property(_playerc.playerc_coopobject_RSSIsender_get, _playerc.playerc_coopobject_RSSIsender_set)
    ...
    if _newclass:RSSIvalue = _swig_property(_playerc.playerc_coopobject_RSSIvalue_get, _playerc.playerc_coopobject_RSSIvalue_set)
    ...
    if _newclass:RSSIstamp = _swig_property(_playerc.playerc_coopobject_RSSIstamp_get, _playerc.playerc_coopobject_RSSIstamp_set)
    ...
    if _newclass:RSSInodeTimeHigh = _swig_property(_playerc.playerc_coopobject_RSSInodeTimeHigh_get, _playerc.playerc_coopobject_RSSInodeTimeHigh_set)
    ...
    if _newclass:RSSInodeTimeLow = _swig_property(_playerc.playerc_coopobject_RSSInodeTimeLow_get, _playerc.playerc_coopobject_RSSInodeTimeLow_set)
    __swig_setmethods__["x"] = _playerc.playerc_coopobject_x_set
    __swig_getmethods__["x"] = _playerc.playerc_coopobject_x_get
    if _newclass:x = _swig_property(_playerc.playerc_coopobject_x_get, _playerc.playerc_coopobject_x_set)
    __swig_setmethods__["y"] = _playerc.playerc_coopobject_y_set
    __swig_getmethods__["y"] = _playerc.playerc_coopobject_y_get
    if _newclass:y = _swig_property(_playerc.playerc_coopobject_y_get, _playerc.playerc_coopobject_y_set)
    __swig_setmethods__["z"] = _playerc.playerc_coopobject_z_set
    __swig_getmethods__["z"] = _playerc.playerc_coopobject_z_get
    if _newclass:z = _swig_property(_playerc.playerc_coopobject_z_get, _playerc.playerc_coopobject_z_set)
    ...
    if _newclass:status = _swig_property(_playerc.playerc_coopobject_status_get, _playerc.playerc_coopobject_status_set)
    ...
    if _newclass:sensor_data_count = _swig_property(_playerc.playerc_coopobject_sensor_data_count_get, _playerc.playerc_coopobject_sensor_data_count_set)
    ...
    if _newclass:sensor_data = _swig_property(_playerc.playerc_coopobject_sensor_data_get, _playerc.playerc_coopobject_sensor_data_set)
    ...
    if _newclass:alarm_data_count = _swig_property(_playerc.playerc_coopobject_alarm_data_count_get, _playerc.playerc_coopobject_alarm_data_count_set)
    ...
    if _newclass:alarm_data = _swig_property(_playerc.playerc_coopobject_alarm_data_get, _playerc.playerc_coopobject_alarm_data_set)
    ...
    if _newclass:user_data_count = _swig_property(_playerc.playerc_coopobject_user_data_count_get, _playerc.playerc_coopobject_user_data_count_set)
    ...
    if _newclass:user_data = _swig_property(_playerc.playerc_coopobject_user_data_get, _playerc.playerc_coopobject_user_data_set)
    ...
    if _newclass:command = _swig_property(_playerc.playerc_coopobject_command_get, _playerc.playerc_coopobject_command_set)
    ...
    if _newclass:request = _swig_property(_playerc.playerc_coopobject_request_get, _playerc.playerc_coopobject_request_set)
    ...
    if _newclass:parameters_count = _swig_property(_playerc.playerc_coopobject_parameters_count_get, _playerc.playerc_coopobject_parameters_count_set)
    ...
    if _newclass:parameters = _swig_property(_playerc.playerc_coopobject_parameters_get, _playerc.playerc_coopobject_parameters_set)
    def __init__(self, *args): 
        this = _playerc.new_playerc_coopobject(*args)
        try: self.this.append(this)
        except: self.this = this
    def destroy(self): return _playerc.playerc_coopobject_destroy(self)
    def subscribe(self, *args): return _playerc.playerc_coopobject_subscribe(self, *args)
    def unsubscribe(self): return _playerc.playerc_coopobject_unsubscribe(self)
    def send_position(self, *args): return _playerc.playerc_coopobject_send_position(self, *args)
    def send_data(self, *args): return _playerc.playerc_coopobject_send_data(self, *args)
    def send_cmd(self, *args): return _playerc.playerc_coopobject_send_cmd(self, *args)
    def send_req(self, *args): return _playerc.playerc_coopobject_send_req(self, *args)
...
class playerc_gps(_object):
    ...
    if _newclass:speed = _swig_property(_playerc.playerc_gps_speed_get, _playerc.playerc_gps_speed_set)
    __swig_setmethods__["course"] = _playerc.playerc_gps_course_set
    __swig_getmethods__["course"] = _playerc.playerc_gps_course_get
    if _newclass:course = _swig_property(_playerc.playerc_gps_course_get, _playerc.playerc_gps_course_set)
...
class playerc_graphics2d(_object):
    ...
    def draw_multiline(self, *args): return _playerc.playerc_graphics2d_draw_multiline(self, *args)
...
class playerc_map(_object):
    ...
    if _newclass:data_range = _swig_property(_playerc.playerc_map_data_range_get, _playerc.playerc_map_data_range_set)
...
class playerc_planner(_object):
    ...
    if _newclass:waypoint_distance = _swig_property(_playerc.playerc_planner_waypoint_distance_get, _playerc.playerc_planner_waypoint_distance_set)
    def __init__(self, *args): 
    ...
    def set_cmd_start(self, *args): return _playerc.playerc_planner_set_cmd_start(self, *args)
...
class playerc_imu(_object):
    ...
    def reset_euler(self, *args): return _playerc.playerc_imu_reset_euler(self, *args)
